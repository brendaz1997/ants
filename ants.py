...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if isinstance(insect, QueenAnt)==True and insect.impostor==False:
                return
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        start = self.place
        distance = 0
        while start != hive or start.entrance != None:
            if len(start.bees) != 0 and distance >= self.min_range and distance <= self.max_range:
        ...
        if self.impostor:
            ...
            while next_place.exit != None:
                ...
                if ant!=None:
                    ...
                    if ant.container:
                        if ant.ant != None:
                            if ant.ant not in self.doubled:
                                ant.ant.damage *= 2
                                self.doubled.append(ant.ant)
                if next_place.exit == None:
                    bees_win()
